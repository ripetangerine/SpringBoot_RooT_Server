...
public class ChatMessageService {
    ...
    public ChatMessageEvent getMessages(Long roomId, Long cursor, int size) {
...
//        }
        ...
        return ChatMessageEvent.of(messages, nextCursor);
    }

    public ChatMessageEvent saveMessage(Long roomId, Long senderId, String content) {
        ChatRoomResponse room = chatRoomRepository.findById(roomId)
                .orElseThrow(() -> new IllegalArgumentException("채팅방 없음"));
